...
<body>
    ...
    <div class="app">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <form action="">
                    <input type="text" class="form-control mb-30" placeholder="first name">
                    ...
                    <!-- <input type="checkbox" class="form-check-input mb-3" name="" id=""> -->
                    <button class="btn btn-primary w-70">save</button>
                </form>
            </div>
        </div>
    </div>
