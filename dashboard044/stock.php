...
<body>
    ...
    <div class="app">
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <div>
                                <li class="active">
                                <a class="has-arrow" href="transaction.php" aria-expanded="false">
                                    <span class="nav-title">make transcation</span>
                                </a>
                                <ul aria-expanded="false">
                                <li><a href="deposit.php">Deposit</a></li>
                                <li><a href="invest.php">invest</a></li>
                                <li><a href="withdrawer.php">Withdraw</a></li>
                                <li><a href="history.php">History</a></li>
                                <li><a href="deposit">logout</a></li>
                                </ul>
                                   
                                    </div>

                                    <li> <a href='kyc.php'>KYC Verification</a> </li>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <form action="">
                    <h3>stock and shear investment Deposit</h3>
                    <input type="text" class="form-control mb-3" placeholder="Crypto Deposit">
                    ...
                    <select name="" class="form-control mb-3" id="" >
                        <option value="">STARTER(200-1,999)</option>
                        <option value="">BASIC(200-1,999)</option>
                        <option value="">BASIC(2000-1999)</option>
                        <option value="">XMG(20,000-4999)</option>
                        <option value="">DIAMOND(50,000-999999)</option>
                    </select>
                    <input type="text" class="form-control mb-5" placeholder="Amount">
...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/mentor-bootstrap-4-admin-dashboard-template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2024 14:12:28 GMT -->
</html>
