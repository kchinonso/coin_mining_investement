<?php
$company_name = "Coin mining Investement";
?>
                        ...
                        <div class="menu-wrap">
                            <nav class="menu-nav">
                                ...
                                <ul class="navigation">
                                        ...
                                        <li class="header-login"><a class="" href="login.php">LOGIN</a></li>
                                        <li class="header-login"><a class="" href="register.php">REGISTER</a></li>
                                    </ul>
                                </div>
